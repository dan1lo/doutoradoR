...
library(installr)
updateR()
dadosAdaptabilidade <- read_excel("")

dadosAdp<-read.csv2(file = "dadosAdaptabilidade.csv",header = TRUE, sep = ";", dec=",") # abrir arquivo
...
modelo.v1.fit <- cfa(modelo.v1, data=dadosAdp, std.lv=TRUE,ordered=TRUE ) 
